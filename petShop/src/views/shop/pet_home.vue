		...
		<div class="search_three">
			<van-row>
				<div @click="goSkip('petStoreList','Pet Shop')">
					<van-col span="8"><img class="search_three_icon" src="../../assets/img/nav_shop.png" /></van-col>
				</div>
				<div @click="goSkip('petStoreList','Pet Hotel')">
					<van-col span="8"><img class="search_three_icon" src="../../assets/img/nav_hotel.png" /></van-col>
				</div>
				<div @click="goSkip('petStoreList','Pet Hospital')">
					<van-col span="8"><img class="search_three_icon" src="../../assets/img/nav_hospital.png" /></van-col>
				</div>
				<div @click="goSkip('petStoreList','Pet Shop')">
					<van-col span="8">Shop</van-col>
				</div>
				<div @click="goSkip('petStoreList','Pet Hotel')">
					<van-col span="8">Hotel</van-col>
				</div>
				<div @click="goSkip('petStoreList','Pet Hospital')">
					<van-col span="8">Hosplital</van-col>
				</div>
			</van-row>
		</div>
